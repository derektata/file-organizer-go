...
func Run() {
	...
	// var verbose bool // TODO: Implement verbose mode
	// var dryRun bool // TODO: Implement dry-run mode
	...
	// flag.BoolVarP(&verbose, "verbose", "v", false, "Show detailed output in dry-run mode")
	...
	err = fileOrganizer.OrganizeFiles(prependDate)
